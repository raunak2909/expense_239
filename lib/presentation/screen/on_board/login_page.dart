          ...
          children: [
                  ...
                  if(emailController.text.toString()!="" && passController.text.toString()!="") {
                    ...
                    if (check) {
                      ...
                      ScaffoldMessenger.of(context)
                          .showSnackBar(SnackBar(content: Text('Invaid Credentials')));
                    }
                  } else {
                    ScaffoldMessenger.of(context)
                        .showSnackBar(SnackBar(content: Text('Invaid Email Password')));
                  }
            ...
            InkWell(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: 22, color: Colors.purple.shade600),
                )),
          ],
        ),
      ),
